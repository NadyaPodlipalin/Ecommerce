...
import { ArticleDate, StyledArticleDiv, StyledArticleHeading, StyledArticleHeading2, StyledArticleImage, StyledArticlePage, StyledArticleParagraph, StyledDateArticle, StyledDateSection, StyledIconDateArticle, StyledIconDateSection, StyledImage, StyledPicturesArticle } from './Blog.style'
...
const ArticlePage = () => {
    return (<>
        ...
        <StyledArticlePage>
            ...
            <ArticleDate>
                <StyledIconDateArticle />
                <StyledDateArticle>22.01.2023</StyledDateArticle>
            </ArticleDate>
            ...
            <StyledArticleParagraph>Do them at home, in the gym, or outdoors – whenever and wherever you want. Plus, our free video library is constantly growing, so expect new videos to flow in.
            </StyledArticleParagraph>

            <StyledArticleParagraph>No matter what fitness level you're at, NTC will give you the tools you need to succeed.
            </StyledArticleParagraph>
